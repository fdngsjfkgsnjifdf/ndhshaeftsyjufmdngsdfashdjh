...
public class Auto {
    ...
    public void updateAutoPickup() {
        ...
        if (amount == 0 || mindustry.Vars.player.isDead()) return;
    ...
    public void updateItemSourceTracking() {
        ...
        if (targetItemSource.block() != Blocks.itemSource) {
            griefWarnings.sendMessage("[#FF26FF]ALERT! Item source " + griefWarnings.formatTile(targetItemSource) + " HAS BEEN DELETED");
            targetItemSource = null;
            return;
        }
